...
function Production() {
    ...
    const {
        ...
        queryFn: () =>
            getProductNames(selectedCategory, searchParams.get("crop")),
        enabled:
            Boolean(searchParams.get("crop")) &&
            searchParams.get("crop") !== "undefined",
    });
                ...
                >
                    <FormControl size="small">
                        ...
                        >
                            ...
                            <MenuItem value="harvested-products">
                                Harvested Products
                            </MenuItem>
                            <MenuItem value="soil-health">Soil Health</MenuItem>
                            <MenuItem value="organic-inorganic">
                                Organic/Inorganic
                            </MenuItem>
                            ...
                            <MenuItem value="selling-channel">
                                Selling Channel
                            </MenuItem>
                            <MenuItem value="storage-facility">
                                Storage Facility
                            </MenuItem>
                            <MenuItem value="other-informations">
                                Other Informations
                            </MenuItem>
                        </Select>
                    </FormControl>
