          ...
          >
            Herbs
                            ...
                            <Link
                                ...
                                className={
                                    paths.includes("fuits-vegetables")
                                        ? "link active"
                                        : "link"
                                }
                            >
                            ...
                            <Link
                                ...
                                className={
                                    paths.includes("processed-foods")
                                        ? "link active"
                                        : "link"
                                }
                            >
                    ...
                    <Link
                        to="/users"
                        className={
                            paths.includes("users") ? "link active" : "link"
                        }
                    >
                    ...
                    <Link
                        to="/settings"
                        className={
                            paths.includes("settings") ? "link active" : "link"
                        }
                    >
                        <i className="fa-solid fa-gear"></i>
                        <p>Settings</p>
