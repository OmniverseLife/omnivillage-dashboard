...
import { mobility_officer_types } from "../../../helper/constants";

function MobilityOfficerDropdown() {
    ...
    const {
        ...
        queryKey: ["mobility_officer_dropdowns"],
        queryFn: () => getModeratorDropdownValues("mobility"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {mobility_officer_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="mobility"
            rows={rows}
            columns={columns}
            types={mobility_officer_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Mobility Officer Dropdown"
...
export default MobilityOfficerDropdown;
