...
import { community_officer_types } from "../../../helper/constants";
import Dropdown from "./dropdown";

function CommunityOfficerDropdown() {
    ...
    const {
        ...
        queryKey: ["community_officer_dropdowns"],
        queryFn: () => getModeratorDropdownValues("community"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {community_officer_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="community"
            rows={rows}
            columns={columns}
            types={community_officer_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Community Officer Dropdown"
...
export default CommunityOfficerDropdown;
