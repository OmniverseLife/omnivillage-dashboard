...
import { energy_officer_types } from "../../../helper/constants";

function EnergyOfficerDropdown() {
    ...
    const {
        ...
        queryKey: ["energy_officer_dropdowns"],
        queryFn: () => getModeratorDropdownValues("energy"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {energy_officer_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="energy"
            rows={rows}
            columns={columns}
            types={energy_officer_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Energy Officer Dropdown"
...
export default EnergyOfficerDropdown;
