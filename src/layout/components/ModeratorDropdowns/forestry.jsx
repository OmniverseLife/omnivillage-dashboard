...
import { forestry_officer_types } from "../../../helper/constants";

function ForestryOfficerDropdown() {
    ...
    const {
        ...
        queryKey: ["forestry_officer_dropdowns"],
        queryFn: () => getModeratorDropdownValues("forestry"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {forestry_officer_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="forestry"
            rows={rows}
            columns={columns}
            types={forestry_officer_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Forestry Officer Dropdown"
...
export default ForestryOfficerDropdown;
