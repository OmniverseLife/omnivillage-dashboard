...
import { landholding_officer_types } from "../../../helper/constants";

function LandholdingModeratorDropdown() {
    ...
    const {
        ...
        queryKey: ["landholding_officer_dropdowns"],
        queryFn: () => getModeratorDropdownValues("landholding"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {landholding_officer_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="landholding"
            rows={rows}
            columns={columns}
            types={landholding_officer_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Landholding Officer Dropdown"
...
export default LandholdingModeratorDropdown;
