...
import { personal_household_types } from "../../../helper/constants";

function PersonalHouseholdDropdown() {
    ...
    const {
        ...
        queryKey: ["personal_household_dropdowns"],
        queryFn: () =>
            getDropdownValues("other_personal_household_items_dropdown"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {personal_household_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        // <Wrapper>
        <Dropdown
            dropdown_type="other_personal_household_items_dropdown"
            rows={rows}
            columns={columns}
            types={personal_household_types}
            isLoading={isLoading}
            editItem={editItem}
            setEdit={setEditItem}
            refetch={refetch}
            ...
            deleteId={deleteId}
            sectionName="Other Personal & Household items Dropdown"
...
export default PersonalHouseholdDropdown;
