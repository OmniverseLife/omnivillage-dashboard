...
import { demographic_types } from "../../../helper/constants";

function DemographicDropdown() {
    ...
    const {
        ...
        queryKey: ["demographic_dropdowns"],
        queryFn: () => getDropdownValues("demographic"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {demographic_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        ...
        <Dropdown
            ...
            deleteId={deleteId}
            sectionName="Demographic Dropdown"
...
export default DemographicDropdown;
