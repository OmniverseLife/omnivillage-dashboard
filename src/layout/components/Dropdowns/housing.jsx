...
import { housing_types } from "../../../helper/constants";

function HousingDropdown() {
    ...
    const {
        ...
        queryKey: ["housing_dropdowns"],
        queryFn: () => getDropdownValues("housing"),
    });
