...
import { energy_types } from "../../../helper/constants";

function EnergyDropdown() {
    ...
    const {
        ...
        queryKey: ["energy_dropdowns"],
        queryFn: () => getDropdownValues("energy"),
    });
