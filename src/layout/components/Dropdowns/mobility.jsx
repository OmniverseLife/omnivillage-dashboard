...
import { mobility_types } from "../../../helper/constants";

function MobilityDropdown() {
    ...
    const {
        ...
        queryKey: ["mobility_dropdowns"],
        queryFn: () => getDropdownValues("mobility"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {mobility_types[params.row.type]}
                </Typography>
            ),
        },
        {
