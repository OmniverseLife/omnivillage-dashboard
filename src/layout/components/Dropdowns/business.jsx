...
import { business_types } from "../../../helper/constants";
...
function BusinessDropdown() {
    ...
    const {
        ...
        queryKey: ["business_dropdowns"],
        queryFn: () => getDropdownValues("business"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {business_types[params.row.type]}
                </Typography>
            ),
        },
        {
