...
import { landholding_types } from "../../../helper/constants";

function LandholdingDropdown() {
    ...
    const {
        ...
        queryKey: ["landholding_dropdowns"],
        queryFn: () => getDropdownValues("landholding"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {landholding_types[params.row.type]}
                </Typography>
            ),
        },
        {
    ...
    return (
        ...
        <Dropdown
            ...
            deleteId={deleteId}
            sectionName="Landholding Dropdown"
...
export default LandholdingDropdown;
