...
import { forestry_types } from "../../../helper/constants";

function ForestryDropdown() {
    ...
    const {
        ...
        queryKey: ["forestry_dropdowns"],
        queryFn: () => getDropdownValues("forestry"),
    });
    ...
    const columns = [
        ...
        { field: "dz_name", headerName: "Dzongkha Name", width: 300 },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    {forestry_types[params.row.type]}
                </Typography>
            ),
        },
        {
...
export default ForestryDropdown;
